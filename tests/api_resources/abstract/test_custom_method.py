...
class TestCustomMethod(object):
    ...
    class MyResource(stripe.api_resources.abstract.APIResource):
        ...
        async def do_stream_stuff(self, idempotency_key=None, **params):
    ...
    async def test_call_custom_stream_method_class(self, request_mock):
        ...
        resp = await self.MyResource.do_stream_stuff("mid", foo="bar")
    ...
    async def test_call_custom_stream_method_class_with_object(self, request_mock):
        request_mock.stub_request_stream(
            "post",
            "/v1/myresources/mid/do_the_stream_thing",
            "response body",
        ...
        obj = self.MyResource.construct_from({"id": "mid"}, "mykey")
        resp = await self.MyResource.do_stream_stuff(obj, foo="bar")
    ...
    async def test_call_custom_stream_method_instance(self, request_mock):
        request_mock.stub_request_stream(
            "post",
            "/v1/myresources/mid/do_the_stream_thing",
            "response body",
        ...
        obj = self.MyResource.construct_from({"id": "mid"}, "mykey")
        resp = await obj.do_stream_stuff(foo="bar")
    ...
    async def test_call_custom_method_class_special_fields(self, request_mock):
        request_mock.stub_request(
            "post",
            "/v1/myresources/mid/do_the_thing",
            {"id": "mid", "thing_done": True},
        ...
        await self.MyResource.do_stuff(
            "mid",
            foo="bar",
    ...
    async def test_call_custom_method_class_newcodegen_special_fields(
        self, request_mock
    ):
        request_mock.stub_request(
            "post",
        ...
        await self.MyResource.do_stuff_new_codegen(
            "mid",
            foo="bar",
            stripe_version="2017-08-15",
            api_key="APIKEY",
    ...
    async def test_call_custom_method_instance_newcodegen_special_fields(
        self, request_mock
    ):
        request_mock.stub_request(
            "post",
        ...
        obj = self.MyResource.construct_from({"id": "mid"}, "mykey")
        await obj.do_stuff_new_codegen(
            foo="bar",
            stripe_version="2017-08-15",
            api_key="APIKEY",
            idempotency_key="IdempotencyKey",

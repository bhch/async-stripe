...
class TestSearchableAPIResource(object):
    ...
    async def test_search(self, request_mock):
        ...
        res = await self.MySearchable.search(query='currency:"CAD"')
    ...
    async def test_search_multiple_pages(self, request_mock):
        request_mock.stub_request(
            "get",
            "/v1/mysearchables/search",
            {
        ...
        res2 = await self.MySearchable.search(

...
class TestBitcoinReceiver(object):
    ...
    async def test_has_receiver_instance_url(self):
    ...
    async def test_is_listable(self, request_mock):
        resources = await stripe.BitcoinReceiver.list()
    ...
    async def test_is_retrievable(self, request_mock):
        resource = await stripe.BitcoinReceiver.retrieve(TEST_RESOURCE_ID)

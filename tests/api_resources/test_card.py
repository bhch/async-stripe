...
class TestCard(object):
    ...
    async def test_has_account_instance_url(self):
    ...
    async def test_has_customer_instance_url(self):
    ...
    async def test_has_recipient_instance_url(self):
    ...
    async def test_is_not_retrievable(self):
        with pytest.raises(NotImplementedError):
            await stripe.Card.retrieve(TEST_RESOURCE_ID)
    ...
    async def test_is_not_modifiable(self):
        with pytest.raises(NotImplementedError):
            await stripe.Card.modify(TEST_RESOURCE_ID, metadata={"key": "value"})

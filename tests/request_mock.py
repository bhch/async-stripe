...
class RequestMock(object):
    ...
    async def _patched_request(self, requestor, method, url, *args, **kwargs):
        ...
        return await self._real_request(requestor, method, url, *args, **kwargs)

    async def _patched_request_stream(self, requestor, method, url, *args, **kwargs):
        response = self._stub_request_handler.get_response(
        ...
        return await self._real_request_stream(

...
class TestGeneratedExamples(object):
    ...
    async def test_apps_secret_list2(self, request_mock):
        await stripe.apps.Secret.list(scope={"type": "account"}, limit=2)
        request_mock.assert_requested("get", "/v1/apps/secrets")
    ...
    async def test_financial_connections_account_disconnect2(self, request_mock):
        await stripe.financial_connections.Account.disconnect("fca_xxxxxxxxxxxxx")
        request_mock.assert_requested(
            "post",
    ...
    async def test_paymentintent_verify_microdeposits2(self, request_mock):
        await stripe.PaymentIntent.verify_microdeposits(
            "pi_xxxxxxxxxxxxx",
            amounts=[32, 45],
        )
        request_mock.assert_requested(
    ...
    async def test_setupintent_verify_microdeposits2(self, request_mock):
        await stripe.SetupIntent.verify_microdeposits(
            "seti_xxxxxxxxxxxxx",
            amounts=[32, 45],
        )
        request_mock.assert_requested(
    ...
    async def test_treasury_outboundpayment_retrieve(self, request_mock):
        await stripe.treasury.OutboundPayment.retrieve("bot_xxxxxxxxxxxxx")
        request_mock.assert_requested(
            "get",
    ...
    async def test_treasury_outboundpayment_cancel(self, request_mock):
        await stripe.treasury.OutboundPayment.cancel("bot_xxxxxxxxxxxxx")
        request_mock.assert_requested(
            "post",

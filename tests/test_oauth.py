...
class TestOAuth(object):
    ...
    async def test_token(self, request_mock):
    ...
    async def test_deauthorize(self, request_mock):
        request_mock.stub_request(
            "post",
            "/oauth/deauthorize",
        ...
        resp = await stripe.OAuth.deauthorize(stripe_user_id="acct_test_deauth")
        request_mock.assert_requested(
            "post",
            "/oauth/deauthorize",
